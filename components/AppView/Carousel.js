...
const PageContent = ({trackData, renewTracks}) => {
    ...
    useEffect(() => {
        ...
        if (currentTrack > (tracks.length / 2)) {
            renewTracks(true)
        }
...
const Carousel = ({isLoading, trackData, renewTracks}) => {
    if (isLoading) return <LoadingComponent/>
    return <PageContent trackData={trackData} renewTracks={renewTracks}/>
